...
public class CityStream {
    ...
    private static List<String> filterCities(List<String> cityList, char firstLetter) {
        return cityList.stream()
                .filter(city -> city.toLowerCase().startsWith(String.valueOf(firstLetter))) //filter by 'b'
                .map(String::toUpperCase) //converting to Upper Case
                .sorted() //sorting by alphabet
                .toList() //putting into list
                .reversed();
    }
